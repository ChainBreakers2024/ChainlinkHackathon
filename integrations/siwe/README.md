# Sign-In with Ethereum - ChainBreakers Integration

Welcome to the [Sign-In with Ethereum](https://login.xyz/) ChainBreakers Integration! This integration provides a secure and straightforward method for users to authenticate themselves using their Ethereum wallets.
